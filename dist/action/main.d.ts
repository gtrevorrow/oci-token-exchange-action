...
export declare function tokenExchangeJwtToUpst(platform: Platform, { tokenExchangeURL, clientCred, ociPublicKey, subjectToken, retryCount, rpstResourceType, rpstExpiration, currentAttempt, }: TokenExchangeConfig): Promise<UpstTokenResponse>;
